...
const env = {
  ...
  emailFrom: process.env.EMAIL_FROM || 'noreply@riogroove.store',
  resendApiKey: process.env.RESEND_API_KEY || '',
  whatsappZapiUrl: process.env.WHATSAPP_ZAPI_URL || '',
  whatsappZapiToken: process.env.WHATSAPP_ZAPI_TOKEN || '',
